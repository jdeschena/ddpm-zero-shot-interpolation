...
from diff_exp.utils import save_args_to_cfg, add_args, default_arguments as cli_defaults, parse_args, spectral_norm
...
def add_sn(m, l):    
    if isinstance(m, (th.nn.Conv2d, th.nn.Linear)):
        ...
        #return spectral_norm(m, n_power_iterations=2, lipschitz=l)
        return m
    else:
        return m
...
def main():
    ...
    def forward_backward_log(data_loader, prefix="train"):
        ...
        for i, (sub_batch, sub_labels, sub_t) in enumerate(
            ...
            log_loss_dict(logger, diffusion, sub_t, losses)
            del losses
            loss = loss.mean()
