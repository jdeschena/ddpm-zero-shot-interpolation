...
uncond_path = "/home/anon/samples/blond_black_hair_5_ensemble/uncond/samples_10000x64x64x3.npz"
cond_path = "/home/anon/samples/blond_black_hair_5_ensemble/guid_30/samples_10000x64x64x3.npz"
...
plt.legend()
plt.tight_layout()
plt.savefig("hair_color_uncond_vs_cond.pdf")
plt.clf()
...
prefix = "blond_black_hair_mild"
for idx in mild_idxs:
    img = cond_dataset[idx][0]
    img = Image.fromarray(img)
    save_path = os.path.join(prefix, f"{idx}.png")
    mkdirs4file(save_path)
    img.save(save_path)

print("Done on guidance 30")
